    ...
    <footer className="bg-slate-900 text-slate-200 py-12 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <h2 className="text-emerald-400 text-2xl font-medium">Sanea</h2>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-emerald-400 transition-colors">Control de Plaga</a></li>
            <li><a href="#" className="hover:text-emerald-400 transition-colors">Desinfección de Ambientes</a></li>
            <li><a href="#" className="hover:text-emerald-400 transition-colors">Limpieza de Reservorios de Agua</a></li>
            <li><a href="#" className="hover:text-emerald-400 transition-colors">Control aviar y Animales menores</a></li>
            <li><a href="#" className="hover:text-emerald-400 transition-colors">Mantenimiento de Reservorios de agua</a></li>
